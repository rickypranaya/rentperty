...
const L_FindAgent = props=>{
        ...
        return(
            ...
            onPress={()=>{
                props.navigation.navigate({
                    name: 'chatRoom',
                    params: { name: item.item.first_name + " "+ item.item.last_name}
                  })
            }}>
                ...
                <View style={{flex:1, paddingHorizontal:10, justifyContent:'center'}}>
                    ...
                    <View style={{flexDirection:'row', alignItems:'center', justifyContent:'space-between'}}>    
                        ...
                        <Text numberOfLines={1} style={{fontSize: 15,  paddingVertical:3}}>{item.item.agency}</Text>
                    </View> 
                </View>
    ...
    return(
        ...
        <Header header={true} title='Find Agent' onBack={()=>{props.navigation.goBack()}}/>
        </View>
    );
}
