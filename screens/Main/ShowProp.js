...
const ShowProp = props=>{
    ...
    const [isShortlisted, setShortlist] = useState(false)
    ...
    return(
        <View style={styles.screen}>
            ...
            <Animated.View style={styles.bottomAction}>
                <TouchableOpacity onPress={()=>{setShortlist(!isShortlisted)}}>
                    {!isShortlisted? 
                    <Icon
                    // reverse
                    name='heart-o'
                ...
                >
                    <Text style = {styles.secondary_button_text}>Chat</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.main_button } onPress={() => { 
                    ...
                    <Text style = {styles.main_button_text}>Enquire Now</Text>
                </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    secondary_button:{
        ...
        borderWidth:1.5,
        alignItems:'center',
        width: Constant.DEVICE_WIDTH * 0.25,
